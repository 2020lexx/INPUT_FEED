...
<script language="javascript" type="text/javascript" src="<?php echo $path; ?>modules/out/graph/visualisations/common/api.js"></script>
<script language="javascript" type="text/javascript" src="<?php echo $path; ?>modules/out/graph/visualisations/common/inst.js"></script>

<script language="javascript" type="text/javascript" src="<?php echo $path; ?>modules/out/graph/visualisations/multigraph.js"></script>
<script language="javascript" type="text/javascript" src="<?php echo $path; ?>modules/out/graph/multigraph_edit.js"></script>
