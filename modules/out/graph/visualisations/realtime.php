...
<html>
 ...
 ?>
        ...
        <script language="javascript" type="text/javascript" src="<?php echo $httpRootDir; ?>modules/out/graph/visualisations/common/api.js"></script>
    </head>
    <body>
   ...
   var path = "<?php echo $graphQueryPage; ?>";
    ...
    $.ajax({                                      
      url: path,                         
      data: "id="+loggerid+"&c_=data&start="+(start-20)+"&end="+(end+20)+"&dp="+1000,
      dataType: 'json',
      async: false,                      
