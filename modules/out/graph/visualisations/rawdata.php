...
<script language="javascript" type="text/javascript" src="<?php echo $httpRootDir; ?>Lib/flot/date.format.js"></script>
...
var loggerid = "<?php echo $session['logger_log_file_id']; ?>";
...
placeholder.height($(window).height()-top_offset);
...
$(function() {
   ...
   /* if (embed==false) {
    ...
    function draw()
    {
        ...
        $.ajax({                                      
            url: path,                         
            data: "id="+loggerid+"&c_=average&start="+view.start+"&end="+view.end+"&interval="+interval,
            dataType: 'json',
            async: false,                      
