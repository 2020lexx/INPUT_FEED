    ...
    */
    ...
    $visualisations = array(
        ...
        'realtime' => array('label'=>_("RealTime"), 'options'=>array(
            array('logger_log_file_id',_("logger_log_file_id"),1))
        ),
        ...
        'bargraph'=> array('label'=>_("BarGraph"), 'options'=>array(
            array('logger_log_file_id',_("logger_log_file_id"),0),
            array('colour',_("colour"),5,'EDC240'),
        ...
        'histgraph'=> array('label'=>_("Histgraph"), 'options'=>array(
            array('logger_log_file_id',_("logger_log_file_id"),3),
            array('barwidth',_("barwidth"),7,50),
            array('start',_("start"),7,0),
            array('end',_("end"),7,0))
        ),
        
        //'dailyhistogram'=> array('options'=>array(array('logger_log_file_id',3))),
        ...
        //'comparison'=> array('options'=>array(array('logger_log_file_id',3))),
        ...
        'orderbars'=> array('label'=>_("OrderBars"), 'options'=>array(
            array('logger_log_file_id',_("logger_log_file_id"),2)
        )),
        ...
        'multigraph' => array ('label'=>_("MultiGraph"), 'graph'=>'multigraph', 'options'=>array(
            array('name_id',_("name_id"),7),
             array('logger_log_file_id',_("logger_log_file_id"),1)) ),
        
        'compare' => array ('label'=>_("Compare"), 'graph'=>'compare', 'options'=>array(
