...
function dial_widgetlist()
{
  ...
  addOption(widgets["dial"], "templ_var",        "templ_var",    "templ_var",        "templ_var value",                                                            []);
  addOption(widgets["dial"], "max",         "value",   "Max value",   "Max value to show",                                                     []);
  addOption(widgets["dial"], "scale",       "value",   "Scale",       "Value is multiplied by scale before display",                           []);
  addOption(widgets["dial"], "units",       "value",   "Units",       "Units to show",                                                         []);
  addOption(widgets["dial"], "offset",      "value",   "Offset",      "Static offset. Subtracted from value before computing needle position", []);
  addOption(widgets["dial"], "type",        "dropbox", "Type",        "Type to show",                                                          typeDropBoxOptions);
  addOption(widgets["dial"], "graduations", "dropbox", "Graduations", "Should the graduation limits be shown",                                 graduationDropBoxOptions);
